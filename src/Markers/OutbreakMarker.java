...
public class OutbreakMarker {
    ...
    public void increaseOutbreakMarker(){
        ...
        //since the game is lost if outbreakCounter reaches 8, there is no need to increase it beyond this value as it might cause the game to continue if the lose statement is badly constructed
